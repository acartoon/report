<template>
    ...
    <QuarterStats :projects="projectsStats" :developers="developersStats" />
...
import json from './quarter.json'
import QuarterStats from './QuarterStats'

export default {
    components: { BaseHeader, TotalStats, QuarterStats },
    name: 'BaseQuarter',
    data() {
        return {
            type: json.type,
    ...
    computed: {
        interval() {
            return `${this.period.quarter} квартал ${this.period.year}`
        },
        datasets() {
